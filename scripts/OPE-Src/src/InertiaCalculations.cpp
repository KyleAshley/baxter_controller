...
double InertiaCalculations::xMomentOfInertia(const SQParameters& sq) {
	if (sq.a1 < 0 || sq.a2 < 0 || sq.a3 < 0 || sq.e1 < 0 || sq.e2 < 0) {
		return 0;
...
double InertiaCalculations::yMomentOfInertia(const SQParameters& sq) {
	if (sq.a1 < 0 || sq.a2 < 0 || sq.a3 < 0 || sq.e1 < 0 || sq.e2 < 0) {
		return 0;
...
double InertiaCalculations::zMomentOfInertia(const SQParameters& sq) {
	if (sq.a1 < 0 || sq.a2 < 0 || sq.a3 < 0 || sq.e1 < 0 || sq.e2 < 0) {
		return 0;
