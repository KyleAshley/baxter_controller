    ...
    if(pbClient_.getRunningWithLock())
    {
        ...
        */
        ...
        if(std::isnan(pos_.x) || std::isnan(pos_.z)) {
            ...
            if(((pbClient_.pbX <= waypoints_.front().x + 500 && pbClient_.pbX >= waypoints_.front().x - 500) && (pbClient_.pbY <= waypoints_.front().z + 500 && pbClient_.pbY >= waypoints_.front().z - 500)) || waypoints_.size() > 10)
            {   
