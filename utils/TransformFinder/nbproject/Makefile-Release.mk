...
${OBJECTDIR}/src/PointCloudCapture.o: src/PointCloudCapture.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -I/usr/include/pcl-1.7 -I/opt/ros/hydro/include -I/usr/include/eigen3 -I/usr/include/ni -I/usr/include/vtk-5.8 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/PointCloudCapture.o src/PointCloudCapture.cpp

${OBJECTDIR}/src/main.o: src/main.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -I/usr/include/pcl-1.7 -I/opt/ros/hydro/include -I/usr/include/eigen3 -I/usr/include/ni -I/usr/include/vtk-5.8 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/main.o src/main.cpp
